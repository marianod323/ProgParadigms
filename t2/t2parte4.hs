...
-- 1) Usando encodeChar e decodeChar, defina uma função shiftChar :: Char -> Int -> Char.
--    Essa função, ao receber um caracter de 'a' a 'z', aplicará um deslocamento de 'n' unidades
...
-- 3) Defina uma função countValids :: String -> Int, que receba uma string e
--    retorne a quantidade de seus caracteres contidos no intervalo ['a'..'z']

countValids :: String -> Int
countValids str = length (filter (`elem` ['a'..'z']) str)
